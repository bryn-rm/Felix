    ...
    async def answer_with_tools(
        ...
        *,
        ...
        chat_system = (
            ...
            "times in the same turn — once for each event — before replying. The server stores "
            "every proposal. Describe what you've staged to the user in plain text and ask them "
            "to confirm.\n"
