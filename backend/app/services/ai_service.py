    ...
    async def answer_with_tools(
        ...
        *,
        ...
        chat_system = (
            ...
            "Trust your own prior turns. Anything you stated in an earlier assistant message in "
            "this conversation (dates, times, venues, attendee names, email subjects) is reliable "
            "context — use it directly for follow-up actions. Do NOT re-run search_emails or "
